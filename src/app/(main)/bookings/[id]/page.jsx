              ...
              <Card>
                <CardContent className="px-6 py-3">
                  ...
                  <div className="text-left">
                    ...
                    {/* {bookingDetails.worker.verified && (
                    <Badge
                    ...
                    <div className="flex mb-4 items-center">
                      ...
                      <span className="ml-2 text-sm text-gray-600">
                        {bookingDetails.worker.rating}
                      </span>
                    </div>
                    <div className="space-y-2">
                      <Button
                        className="w-full !rounded-button bg-orange whitespace-nowrap cursor-pointer"
                        onClick={() => setShowContactModal(true)}
                      >
              ...
              <Card>
                <CardContent className="p-6">
                  ...
                  <div className="space-y-3">
                    ...
                    <button className="w-full text-red-600 border-red-200 hover:bg-red-50 !rounded-button whitespace-nowrap cursor-pointer">
            ...
            <div className="bg-white border-2 rounded-lg p-6 max-w-md w-full mx-4">
              <div className="flex justify-between items-center mb-4">
                <h3 className="text-lg font-semibold">
                  Contact {bookingDetails.worker.name}
                </h3>
                <Button
